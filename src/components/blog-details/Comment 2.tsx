// ============================================================
// COMMENT — src/components/blog-details/Comment.tsx
// ============================================================
      ...
      <article className="mx-auto mt-10 max-w-[850px] md:mt-[72px]">
        <div className="mb-[70px] space-y-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="text-tagline-1 font-medium">Adaeze Okonkwo</h3>
              <time
                dateTime="2026-02-14"
          ...
          <p>
            This is exactly what we needed. Our social media was a mess before NativPost — inconsistent posting,
            off-brand captions, zero engagement. This article captures the problem perfectly.
          </p>
        ...
        <div className="dark:bg-background-8 max-w-[850px] rounded-[20px] bg-white px-4 py-6 md:w-full md:p-6 lg:p-[42px]">
          <h5 className="text-heading-6 mb-6">Leave a comment</h5>
