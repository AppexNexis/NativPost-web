      ...
      <div className="main-container">
        <div className="mx-auto max-w-[804px] space-y-5 text-center">
          <RevealAnimation delay={0.1}>
            <span className="badge !badge-cyan">Client reviews</span>
          </RevealAnimation>

          <div className="space-y-3">
            <RevealAnimation delay={0.2}>
              <h2>Hear from businesses using NativPost to grow their brands</h2>
            </RevealAnimation>

            <RevealAnimation delay={0.3}>
              <p>
                From startups to established brands, our clients trust NativPost to deliver consistent, on-brand social
                media content that drives real engagement — without the agency price tag.
              </p>
            </RevealAnimation>
          </div>
        </div>
