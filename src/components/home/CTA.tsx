          ...
          <div className="mx-3 max-w-[649px] space-y-3 text-center sm:mx-0 md:w-full xl:text-left">
            ...
            <div className="space-y-3">
              <RevealAnimation delay={0.4}>
                <h2
                  className="text-heading-4 lg:text-heading-2 mx-auto max-w-[449px] lg:mx-0 lg:text-left"
                  aria-label="cta-heading">
                  Ready to transform your
                  <span className="text-primary-500"> social media presence?</span>
                </h2>
              </RevealAnimation>
