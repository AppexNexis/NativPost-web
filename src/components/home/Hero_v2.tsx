...
───────────────────────────────────────────── */
const VIDEO_SRC = '/videos/nativpost-demo.mp4'; // ← swap this
...
const DemoVideo = () => {
  ...
  useEffect(() => {
    ...
    video.muted = true;
    video.play().catch(() => {
      // Autoplay blocked — video stays paused but visible
    });
  }, []);
  ...
  return (
    <div className="relative w-full overflow-hidden rounded-2xl">
      ...
      <div className="relative bg-[#0d0d0d]" style={{ aspectRatio: '16/9' }}>
        ...
        {/* Fallback placeholder if no video file provided */}
        {hasError && (
        ...
        <div
          ...
          style={{
            background:
              'linear-gradient(to bottom, transparent 70%, rgba(0,0,0,0.18) 100%)',
          }}
        />
    ...
    <section className="dark:bg-background-5 relative overflow-hidden bg-white pt-[140px] pb-[90px] lg:pt-[170px] lg:pb-[120px]">
      ...
      <div className="main-container relative z-10">
        <div className="flex flex-col gap-10 lg:flex-row lg:items-center lg:justify-between">
          ...
          {/* ───────────────── LEFT ───────────────── */}
          <div className="flex min-w-0 flex-1 flex-col gap-5 text-center lg:text-left max-w-[580px]">
          ...
          <RevealAnimation delay={0.5} offset={30}>
            <div
              className="w-full shrink-0 lg:w-[500px] xl:w-[560px] 2xl:w-[600px]"
              style={{
                /* Multi-layered shadow for floating card effect */
                filter: 'drop-shadow(0 24px 60px rgba(0,0,0,0.12)) drop-shadow(0 4px 12px rgba(0,0,0,0.06))',
              }}>
