          ...
          <div className="flex-1 min-w-0 flex flex-col gap-6 text-center lg:text-left">
            ...
            <RevealAnimation delay={0.1}>
              <span className="inline-flex items-center gap-2 text-xs px-4 py-2 rounded-full border border-black/10 bg-[#f5f5f5] text-[#292929] shadow-sm w-fit mx-auto lg:mx-0">
                ...
                AI social media, built for real brands
              </span>
            </RevealAnimation>

            <RevealAnimation delay={0.2}>
              <h1 className="text-[30px] sm:text-4xl lg:text-[36px] xl:text-[42px] 2xl:text-[46px] font-extrabold leading-[1.15] tracking-tight text-gray-950 dark:text-white">
                Your brand voice, everywhere,{' '}
                <span className="text-primary-500">managed from WhatsApp.</span>
              </h1>
            </RevealAnimation>
