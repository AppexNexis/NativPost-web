      ...
      <div className="main-container">
          ...
          <div className="space-y-3">
            <RevealAnimation delay={0.2}>
              <h2 className="mx-auto max-w-[658px]">
                Save hours every week &amp; grow your
                <span className="text-primary-500"> social presence</span>
              </h2>
            </RevealAnimation>
        ...
        <div>
          <RevealAnimation delay={0.4}>
            <div className="bg-secondary dark:bg-background-9 main-container flex flex-col rounded-[20px] px-6 py-6 md:flex-row md:px-0">
              <div className="border-b-accent/20 border-r-accent/20 flex-1 space-y-6 border-b py-6 md:border-r md:border-b-0">
                <span className="bg-ns-yellow mx-auto flex h-10 w-16 items-center justify-center rounded-full lg:h-[52px] lg:w-20">
              ...
              <div className="border-b-accent/20 border-r-accent/20 flex-1 space-y-6 border-b py-6 md:border-r md:border-b-0">
                <span className="bg-ns-cyan mx-auto flex h-10 w-16 items-center justify-center rounded-full lg:h-[52px] lg:w-20">
                  <svg xmlns="http://www.w3.org/2000/svg" className="size-5 lg:size-6" viewBox="0 0 24 24" fill="none">
                    <path
                ...
                <div className="text-center">
                  <h3 className="lg:text-heading-6 text-tagline-1 flex items-center justify-center font-normal text-white">
                    <NumberAnimation number={10} speed={1000} interval={180} rooms={2} heightSpaceRatio={2.5} /> + Hours
                    saved per week
                  </h3>
                </div>
              </div>
              <div className="flex-1 space-y-6 py-6">
                <span className="bg-ns-red mx-auto flex h-10 w-16 items-center justify-center rounded-full lg:h-[52px] lg:w-20">
                  <svg xmlns="http://www.w3.org/2000/svg" className="size-5 lg:size-6" viewBox="0 0 24 24" fill="none">
                    <path
