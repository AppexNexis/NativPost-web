...
const featuresData = [
  {
    id: 1,
    icon: 'ns-shape-8',
    title: 'Deep brand-voice matching',
  },
  {
    id: 2,
    icon: 'ns-shape-9',
    title: 'Anti-slop quality filter on every post',
  },
  {
    id: 3,
    icon: 'ns-shape-12',
  ...
  },
  {
    id: 4,
    icon: 'ns-shape-21',
    title: 'Cross-platform publishing in one click',
  },
];
          ...
          <div className="col-span-12 lg:col-span-6 xl:col-span-7">
            <RevealAnimation delay={0.2} offset={100}>
              <figure className="mx-auto w-full max-w-[450px] md:max-w-[550px] lg:max-w-[647px]">
                <Image src={selectUs} alt="Why brands choose NativPost" className="h-full w-full object-cover dark:hidden" />
                <Image
                  src={selectUsDark}
                  alt="Why brands choose NativPost"
                ...
                <div className="space-y-3">
                  <RevealAnimation delay={0.2}>
                    <h2 className="max-w-[420px] xl:max-w-full">
                      Why <span className="text-primary-500">growing brands </span> trust NativPost
                    </h2>
                  </RevealAnimation>
                </div>
              </div>
