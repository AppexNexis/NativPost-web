      ...
      <div className="main-container relative z-10">
        <div className="space-y-5 text-center">
          <RevealAnimation delay={0.1}>
            <span className="badge badge-gray-light">Studio-crafted content, zero effort</span>
          </RevealAnimation>
          <div className="space-y-3">
            ...
            <RevealAnimation delay={0.3}>
              <p className="mx-auto max-w-[400px] md:max-w-[600px] lg:max-w-full">
                NativPost creates studio-quality graphics, copy, and scheduling, automatically published to all your
                social channels. Agency quality at product pricing.
              </p>
            </RevealAnimation>
          </div>
        </div>
        ...
        <div className="relative z-10 flex items-end justify-center -space-x-28">
          ...
          <RevealAnimation delay={0.2} offset={100} instant>
            <figure className="shadow-6 relative z-10 w-full max-w-[250px] overflow-hidden rounded-[30px] md:max-w-[300px] lg:max-w-[370px]">
              <Image src={hero1} alt="NativPost dashboard" className="h-full w-full object-cover" />
            </figure>
          </RevealAnimation>
          <RevealAnimation delay={0.5} offset={100} direction="left" instant>
            <figure className="relative -z-10 w-full max-w-[200px] overflow-hidden rounded-[20px] md:max-w-[250px] lg:max-w-[326px]">
              <Image src={hero2} alt="NativPost brand content" className="h-full w-full rounded-[20px] object-cover" />
            </figure>
          </RevealAnimation>
        </div>
      </div>
