          ...
          <div className="flex items-center gap-16 overflow-hidden rounded-4xl bg-white py-2.5 pr-2.5 dark:bg-black">
            <RevealAnimation delay={0.1}>
              <div className="w-full max-w-[400px] px-8 py-14">
                <div className="mb-6">
                  <h2 className="text-heading-5 text-secondary dark:text-accent mb-2">Welcome back</h2>
                  <p className="text-secondary/60 dark:text-accent/60">Log in to your NativPost dashboard</p>
                </div>
                <form className="mb-6">
                ...
                <div>
                  ...
                  <div className="py-8 text-center">
                    <p className="text-tagline-2 text-secondary dark:text-accent font-normal">Or continue with</p>
                  </div>
                  <SocialAuthV2 />
                </div>
              </div>
            ...
            <RevealAnimation delay={0.2} direction="up">
              <div className="hidden lg:block">
                <figure className="w-full max-w-[456px] overflow-hidden rounded-[20px]">
                  <Image src={loginBgImage} priority={true} alt="NativPost dashboard preview" className="size-full object-cover" />
                </figure>
              </div>
            </RevealAnimation>
          </div>
