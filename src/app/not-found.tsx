...
export const metadata: Metadata = {
  ...defaultMetadata,
  title: '404 — Page Not Found | NativPost',
};
            ...
            <div className="bg-background-3 dark:bg-background-5 dark:border-background-9 relative flex flex-col items-center justify-center overflow-hidden rounded-4xl border-[10px] border-white py-10 pr-2.5 text-center md:py-20 lg:py-[100px]">
              ...
              <RevealAnimation delay={0.4}>
                <h2 className="pt-6 pb-3">
                  This page went off-schedule.
                </h2>
              </RevealAnimation>
              <RevealAnimation delay={0.5}>
                <p className="mx-auto mb-10 max-w-[400px] md:mb-14">
                  Unlike your NativPost content, this page didn&apos;t make it to publishing. Let&apos;s get you back on track.
                </p>
              </RevealAnimation>
              <RevealAnimation delay={0.6} instant>
                <div className="flex flex-col items-center gap-4 sm:flex-row">
                  ...
                  <LinkButton href="/pricing" className="btn btn-lg btn-white hover:btn-primary dark:btn-transparent dark:hover:btn-accent">
                    View pricing
                  </LinkButton>
                </div>
              </RevealAnimation>
