...
export const metadata: Metadata = {
  ...
  description:
    'NativPost creates studio-quality branded content — graphics, copy, and scheduling — automatically published to your social channels. The antidote to generic, robotic content.',
};
